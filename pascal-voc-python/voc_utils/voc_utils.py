...
class PascalVOC:
    ...
    def load_data(self, category, data_type=None):
        """
        ...
        filename = os.path.join(self.cache_dir, data_type+'_'+category+'.csv')
    ...
    def get_image_url_list(self, category, data_type=None):
        ...
        """
        df = self.load_data(category, data_type=data_type)
        image_url_list = list(
    ...
    def get_masks(self, cat_name, data_type, mask_type=None):
        ...
        df = self.load_data(cat_name, data_type=data_type)
    ...
    def display_img_and_masks(self, 
